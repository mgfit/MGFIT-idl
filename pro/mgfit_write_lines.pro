...
;-
  ...
  for i=0, nlines-1 do begin
    if lines[i].sigma1 ne 0.0 and lines[i].peak ne 0.0 and lines[i].flux ne 0.0 and lines[i].resolution ne 0.0  then begin
      printf, lun1, format='(F-12.4," ",E-14.7," ",E-14.7," ",E-14.7," ",E-14.7," ",E-14.7," ",E-14.7," ",F-16.10," ",F-16.2," ",I-3," ",A-18," ",A-14," ",A-18," ",A-18," ",A-3," ",A-3)', $
            lines[i].wavelength, lines[i].peak, lines[i].sigma1, lines[i].flux, lines[i].continuum, $
            lines[i].uncertainty, lines[i].pcerror, $
