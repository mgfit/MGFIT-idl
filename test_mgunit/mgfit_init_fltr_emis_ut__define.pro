...
function mgfit_init_fltr_emis_ut::test_basic
  compile_opt strictarr
  
  base_dir = file_dirname(file_dirname((routine_info('mgfit_init_fltr_emis_ut__define', /source)).path))
  data_dir = ['data']
...
pro mgfit_init_fltr_emis_ut__define
  compile_opt strictarr
  
  define = { mgfit_init_fltr_emis_ut, inherits mgfitUTTestCase}
end
