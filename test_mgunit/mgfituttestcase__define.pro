...
function mgfituttestcase::have_dlm, dlm_name
...
function mgfituttestcase::init, _extra=e
  compile_opt strictarr
...
pro mgfituttestcase__define
  compile_opt strictarr

  define = { mgfitUTTestCase, inherits MGutTestCase, $
             nptrs: 0L, $
             nobjs: 0L, $
