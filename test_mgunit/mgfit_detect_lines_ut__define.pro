...
function mgfit_detect_lines_ut::test_basic
  compile_opt strictarr
  
  base_dir = file_dirname(file_dirname((routine_info('mgfit_detect_lines_ut__define', /source)).path))
  data_dir = ['data']
...
pro mgfit_detect_lines_ut__define
  compile_opt strictarr
  
  define = { mgfit_detect_lines_ut, inherits mgfitUTTestCase}
end
